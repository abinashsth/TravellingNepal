...
<body>
    ...
    $sql = "SELECT * FROM `package` WHERE package.cat_id='" . $_GET["cat_id"] ."' ";
    ...
    <div class="trip">
        ...
        <div class="image">
            <img src="Admin/Packages/<?php echo $Package_image1 ?> " " height="800px" width="80%">
        </div>
