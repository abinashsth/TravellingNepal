...
<body>
    ...
    <div class="container">
        ...
        // }
        ?>
        <h1 style='text-align: center; color: #3BBFC3 '> Booking </h1>
                ...
                ?>
                    <tr>
                        ...
                        <?php if ($_SESSION["usertype"] == "admin") { ?>
                            ...
                            <a href="delete_booking.php?booking_id=<?php echo $row["booking_id"] ?>" class="link-dark"  onclick="return confirm('Are you sure you want to delete this item?');">
