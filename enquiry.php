...
//         $error_finder=1;
//   }
//   else if(strlen($_POST['Enquiry_Contact'])<10){
//         $error_number="the number should be 10 length";
//         $error_finder=1;
//   }
...
if(empty($_POST['Enquiry_Contact'])){
    ...
    $error_number = "The number should be at least 10 digits long";
    $error_finder = 1;
}
else if(strlen($_POST['Enquiry_Contact']) > 14){
    $error_number = "Contact cannot be more than 14 digits";
    $error_finder = 1;
}
else{
    $number = $_POST['Enquiry_Contact'];
    if(!preg_match("/^[0-9]*$/", $number)){
        $error_finder = 1;
        $error_number = "Only numbers are allowed";
    }
}
