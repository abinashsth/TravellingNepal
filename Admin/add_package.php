...
if (isset($_POST["submit"])) {
    ...
    if (isset($_FILES["package_image1"])) {
        ...
        // Check file 1 size
        if ($_FILES["package_image1"]["size"] > 2000000) {
    ...
    if ($uploadok1 == 1 && $uploadok2 == 1 && $uploadok3 == 1) {
        ...
        $sql = " INSERT INTO `package`(`pac_id`, `cat_id`,  `Package_title`, `Details`, `Price`, `Duration`, `Max_Evelation`, `Max_Group`, `Best_Time`, `Trip_overview1`, `Image_1`, `Trip_overview2`, `Image_2`, `Trip_overview3`, `Itinerary`, `Include`, `Exclude`, `Map_image`) VALUES 
        (Null,'" . $_POST["cat_select"] . "' , '" . $_POST["package_name"] . "','" . $_POST["package_details"] . "','" . $_POST["package_price"] . "',
