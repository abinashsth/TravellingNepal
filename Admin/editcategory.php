...
if (isset($_POST["submit"])) {
  ...
  $Cat_name = $_POST['Cat_name'];
   $Cat_images = $_POST['Cat_images'];
   $Cat_details = $_POST['Cat_details'];

//   $sql = "UPDATE `` SET `username`='$username',`password`='$password', `type`='$type' WHERE id = $id";
  $sql = "UPDATE `category` SET `Category_Name`='$Cat_name',`Images`=' $Cat_images',`Details`=' $Cat_details' WHERE `cat_id`= $cat_id";
      ...
      <form action="" method="post" style="width:50vw; min-width:300px;">
        <div class="row mb-3">
          ...
          <div class="col">
                        ...
                        <input type="file" name="Cat_images" value= '<?php echo $row['Images'] ?>' />
                    </div>
        </div>
        ...
        <div class="form-group mb-3">
                    ...
                    <textarea id="freeform" name="Cat_details" rows="4" cols="100" value= '<?php echo $row['Details'] ?>'
