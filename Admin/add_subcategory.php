...
if (isset($_POST["submit"])) {
    ...
    if ($uploadok == 1) {
        if (move_uploaded_file($_FILES["Subcat_images"]["tmp_name"], $target_file)) {
            $sql = "INSERT INTO `subcategory` ( `Subcategory_Name`, `cat_id`, `Images`, `Details`) VALUES ('" . $_POST["Subcat_name"] . "','" . $_POST["cat_select"] . "', '" . basename($_FILES["Subcat_images"]["name"]) . "', '" . $_POST["Subcat_details"] . "')";
        ...
        <div class="container d-flex justify-content-center">
            <form action="" method="post" style="width:50vw; min-width:300px;" enctype="multipart/form-data">
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea id="freeform" name="Subcat_details" rows="4" cols="130"
