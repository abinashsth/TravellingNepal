...
if (isset($_POST['submit'])) {
      ...
      if ($error_finder == 0) {
            ...
            $sql = "INSERT INTO `contact`( Name, phone, Email) VALUES ('" . $first . "','" . $number . "','" . $email . "')";
...
<body>
                                    ...
                                    <form action="" method="POST" id="contactForm">
                                          <div class="row g-2 ">
                                                ...
                                                <div class="col">
                                                      ...
                                                      <center>
                                                            <p style="color:red; font-famly:normal;">
                                                                  <?php
  ...
  // Prevent the form from submitting via regular HTTP POST
  ...
  function submitForm() {
    ...
    .fail(function() {
      // Show error message if the server fails to respond
      $("#responseMessage").text("Failed to send message. Please try again later.");
      $("#responseMessage").addClass("error");
    });
  }
});
