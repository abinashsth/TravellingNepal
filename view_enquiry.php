...
<body>
    ...
    <div class="container">
        ...
        // }
        ?>
        <h1 style='text-align: center; color: #3BBFC3 '> Enquiry </h1>
        ...
        <table class="table table-hover text-center">
            ...
            <tbody>
                ...
                <?php
                // $sql = "SELECT * FROM enquiry,package where enquiry.Package_id=package.pac_id";
               ...
               ?>
                    <tr>
                        ...
                        <?php if ($_SESSION["usertype"] == "admin") { ?>
                            ...
                            <a href="delete_enquiry.php?enquiry_id=<?php echo $row["enquiry_id"] ?>" class="link-dark" onclick="return confirm('Are you sure you want to delete this item?');">
