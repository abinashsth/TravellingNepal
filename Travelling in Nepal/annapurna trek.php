...
<!-- about mustang -->
    ...
    <div class="uppar_mustnag">
        <div class="about">
            <p>The Annapurna Circuit is one of the most popular treks in Nepal, and rightly so. On this route, 
                the scenery and culture dramatically change from subtropical forests, paddy fields, and the world’s
                 deepest river gorge to ice flows, a high mountain pass, arid cliffs, and mountain views.</p>
        </div>
    ...
    <div class="icon">
        <div class="icon_">
            <div class="icon_1"><i class="fa-sharp fa-regular fa-calendar-days"></i> <br> Duration:<br> 15 Days</div>
            <div class="icon_2"><i class="fa-sharp fa-solid fa-mountain"></i> <br> Max Elevation:<br> 4200 m</div>
    ...
    <div class="trip">
       ...
       Exploring the tiny village, there are many interesting sights such as almost prehistoric clay effigies. This trek is certainly varied and full of daily
        surprises and interesting finds and accompanied all the way with up close and personal mountain views!</p>
              <div class="image">
             <img src="3.jpg" height="800px" width="80%">
            </div>
    ...
    <div class="map">
        ...
        <div class="map_img">
            <img src="annapurna.jpg" height="800px" width="60%">
        </div>
        
         <div class="google_map">

         <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d56080.77912911838!2d83.83937610904307!3d28.538256016537645!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3995f588b6a4922d%3A0xbaf344120520a16c!2sAnnapurna%20Sanctuary!5e0!3m2!1sen!2snp!4v1685628789538!5m2!1sen!2snp" width="600"
